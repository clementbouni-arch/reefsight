"""ReefSight utility functions: dataset loading (YOLO format), evaluation and plotting.

This module keeps the data plumbing and visualization helpers out of the main notebook so
that the notebook itself can stay focused on the modeling work.
"""
...
def plot_species_counts(fish_df, split="train"):
    ...
    plt.title(f"Photos per species ({split})")
